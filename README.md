...
本项目自身基于 **GNU Affero General Public License v3.0 (AGPL-3.0)** 开源协议。有关更多详细信息，请参阅 [LICENSE](LICENSE) 文件。

同时，本项目包含并使用了以下第三方开源项目的代码：
- **Precise Manufacturing:** 采用 MIT 开源协议。
- **Smooth Swapping:** 采用 GNU Lesser General Public License v3.0 (LGPL-3.0) 开源协议。

关于第三方开源协议的完整文本与详细信息，已统一附在 `LICENSE` 文件的末尾。
