...
import com.minbaka.chnhcore.raritycore.config.StarDisplayConfigManager;
...
public class StarDisplayManager {
    ...
    private void initializeStrategies() {
        ...
        org.slf4j.LoggerFactory.getLogger("RarityCore").debug("星星显示策略初始化完成");
    }
    ...
    public void updateStrategyFromConfig() {
        ...
        org.slf4j.LoggerFactory.getLogger("RarityCore").info("星星显示策略已更新为: {}", currentStrategy != null ? currentStrategy.getName() : "disabled");
    }
    ...
    private StarMode parseStarMode(String modeString) {
        ...
        try {
            ...
            org.slf4j.LoggerFactory.getLogger("RarityCore").warn("无效的星星显示模式: {}, 使用默认模式", modeString);
    ...
    public String getStarDisplayString(int rarity) {
        ...
        try {
            ...
            org.slf4j.LoggerFactory.getLogger("RarityCore").error("获取星星显示字符串时发生错误: 稀有度{}", rarity, e);
            return ""; // 安全回退
        }
    }
    ...
    public void reloadConfiguration() {
        updateStrategyFromConfig();
        org.slf4j.LoggerFactory.getLogger("RarityCore").info("星星显示配置已重新加载");
    }
    ...
    public void cleanup() {
        strategyCache.clear();
        currentStrategy = null;
        org.slf4j.LoggerFactory.getLogger("RarityCore").debug("星星显示管理器已清理");
    }
}