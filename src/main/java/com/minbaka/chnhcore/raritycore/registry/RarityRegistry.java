package com.minbaka.chnhcore.raritycore.registry;
...
public class RarityRegistry {
    ...
    public static @NotNull Integer getNormalizedRarity(@Nullable Item item) {
        ...
        return com.minbaka.chnhcore.raritycore.util.RarityValidator.normalizeRarity(rawRarity);
    }
    ...
    private static String getLocalizedText(String key) {
        try {
            ...
            // 本地化失败时返回原始键
            org.slf4j.LoggerFactory.getLogger("RarityCore").debug("Error getting localized text for key: {}", key, e);
            return key;
        }
    }
    ...
    private static @NotNull String buildLocalizedRarityTooltip(int rawRarity) {
        ...
        int normalizedRarity = com.minbaka.chnhcore.raritycore.util.RarityValidator.normalizeRarity(rawRarity);
        
        if (isSpecialRarity) {
            String stars = com.minbaka.chnhcore.raritycore.util.ComponentBuilder.getStars(displayRarity);
            String customText = com.minbaka.chnhcore.raritycore.config.StarDisplayConfigManager.getCustomSpecialRarityText(displayRarity);
            ...
            String stars = com.minbaka.chnhcore.raritycore.util.ComponentBuilder.getStars(normalizedRarity);
    ...
    private static @NotNull Integer getRarityInternal(ResourceLocation itemId, @Nullable ItemStack itemStack, Item item) {
        ...
        if (tag != null) {
            ...
            if (com.minbaka.chnhcore.raritycore.config.ServerConfigManager.isEnableNbtRarityControl()
        ...
        int tagRarity = com.minbaka.chnhcore.raritycore.config.TagRarityConfigManager.getHighestTagRarity(item);
        if (tagRarity > 1) {
            result = tagRarity;
            source = "tag";
            return fireQueryEvent(itemStack, result, source);
    ...
    private static Integer checkNbtRarity(@Nullable ItemStack itemStack) {
        if (itemStack != null && itemStack.has(net.minecraft.core.component.DataComponents.CUSTOM_DATA)) {
            return 0;
        }
        return null;
    }
    ...
    private static Integer checkApotheosisRarity(@Nullable ItemStack itemStack) {
        if (!com.minbaka.chnhcore.raritycore.config.ServerConfigManager.isCheckApotheosisRarity() || itemStack == null || itemStack.isEmpty()) {
            return null;
        }
    ...
    private static Integer checkApotheosisRarityWithTag(@Nullable ItemStack itemStack, @Nullable CompoundTag tag) {
        if (!com.minbaka.chnhcore.raritycore.config.ServerConfigManager.isCheckApotheosisRarity() || itemStack == null || itemStack.isEmpty() || tag == null) {
            return null;
        }
    ...
    private static Integer checkIronSpellbooksRarity(@Nullable ItemStack itemStack) {
        if (itemStack == null || itemStack.isEmpty() || !itemStack.has(net.minecraft.core.component.DataComponents.CUSTOM_DATA)) {
            return null;
        }
        return 0;
    }
